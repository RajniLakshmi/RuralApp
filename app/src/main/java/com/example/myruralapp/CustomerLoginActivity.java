    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Toast.makeText(CustomerLoginActivity.this, "User logged in ", Toast.LENGTH_SHORT).show();
                    Intent I = new Intent(CustomerLoginActivity.this, CustomerMapActivity.class);
                    startActivity(I);
                } else {
                    Toast.makeText(CustomerLoginActivity.this, "Login to continue", Toast.LENGTH_SHORT).show();
                }
            }
        };
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent I = new Intent(CustomerLoginActivity.this, BuyerOptionsActivity.class);
                startActivity(I);
            }
        });
        btnLogIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userEmail.isEmpty()) {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener() {
                        @Override
